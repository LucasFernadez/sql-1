...
-- Tu respuesta aquí
SELECT COUNT(DISTINCT edad) AS edades_distintas_java FROM usuarios_lenguajes WHERE lenguaje = 'Java';
...
-- Tu respuesta aquí
SELECT COUNT(*) AS mayores_28 FROM usuarios_lenguajes WHERE edad > 28;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS cantidad_lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT COUNT(DISTINCT lenguaje) AS lenguajes_mayores_25 FROM usuarios_lenguajes WHERE edad > 25;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS apellidos_G FROM usuarios_lenguajes WHERE apellido LIKE 'G%';
...
-- Tu respuesta aquí
SELECT COUNT(*) AS total_20_25 FROM usuarios_lenguajes
...
-- Tu respuesta aquí
SELECT nombre, edad, edad - (SELECT AVG(edad) FROM usuarios_lenguajes) AS diferencia_edad
FROM usuarios_lenguajes;

-- Ejercicio 36: Contar cuántos usuarios tienen un lenguaje asociado que contiene la palabra 'Script'.
-- Tu respuesta aquí
SELECT COUNT(*) AS lenguajes_script FROM usuarios_lenguajes
...
-- Tu respuesta aquí
SELECT COUNT(*) AS total_p_menor_28 FROM usuarios_lenguajes
